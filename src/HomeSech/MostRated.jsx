  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
      {topRatedMovies.map((movie, index) => (
        <div key={movie._id} className="group relative bg-card border border-white/20 rounded-xl overflow-hidden transition-all duration-300 hover:shadow-lg hover:shadow-amber-300/20 hover:-translate-y-2" style={{ backgroundColor: 'var(--color-secondary)' }}>
          <div
          ...
          >
            <div className="relative aspect-[2/3] overflow-hidden">
              ...
              <div className="absolute top-2 right-2 bg-amber-300 backdrop-blur-sm rounded-lg px-3 text-black font-bold py-1 transition-all duration-300 group-hover:bg-amber-400">
                <span className="text-sm font-bold">{movie.genre}</span>
              </div>
